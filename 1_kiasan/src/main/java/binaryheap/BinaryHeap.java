 ...
 */
public class BinaryHeap  implements java.io.Serializable{
    ...
    public static IFinitization finBinaryHeap(int maxArrayLength) {
	    IFinitization f = FinitizationFactory.create(BinaryHeap.class);
