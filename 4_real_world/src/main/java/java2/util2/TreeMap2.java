...
//  * @since 1.2
//  */
// public class TreeMap2 extends AbstractMap implements SortedMap, Cloneable, java.io.Serializable {
//   /**
...
//     public boolean containsKey(Object key) {
//       return inRange(key) && TreeMap2.this.containsKey(key);
//     }
...
//           size = 0;
//           sizeModCount = TreeMap2.this.modCount;
//           Iterator i = iterator();
//           while (i.hasNext()) {
//             size++;
//             i.next();
