...
public class RedBlackTree_fix implements Serializable {
   ...
   public static class Node  implements Serializable  {
    ...
    // --------------------- FINITIZATION ------------------------//
    public static IFinitization finRedBlackTree_fix(int size) {
        return finRedBlackTree_fix(size, size, 0, size - 1);
    }

    public static IFinitization finRedBlackTree_fix(int numEntries, int maxSize,int minKey, int maxKey) {
        IFinitization f = FinitizationFactory.create(RedBlackTree_fix.class);
