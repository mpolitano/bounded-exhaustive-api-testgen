 ...
 */
public class AvlTree_fix implements java.io.Serializable {
...
/**************************Finitizaion**************************************/
	...
	public static IFinitization finAvlTree_fix(int maxSize) {
		return finAvlTree_fix(maxSize, maxSize, 0, maxSize -1);
	}
...
stored in the fields of those objects.
	 */
	public static IFinitization finAvlTree_fix(int numAvlNode, int maxSize, int minKey, int maxKey) {

		IFinitization f = FinitizationFactory.create(AvlTree_fix.class);
