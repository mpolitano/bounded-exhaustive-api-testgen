 ...
 * @author fmolina
 */
public class MutationScoreKorat {

  private String objects_file = "/Users/fmolina/phd/software/be-benchmark/scripts/results-begen-serialize/9_taco/rbt.TreeSet/korat/3/korat-tests/objects.ser";
  private int bound = 3; 
  private int structures = 12;
