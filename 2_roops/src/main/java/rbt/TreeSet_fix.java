 ...
 *				)) ; 
 */
public class TreeSet_fix implements java.io.Serializable {
	...
	public static IFinitization finTreeSet_fix(int numEntries) {
		return finTreeSet_fix(numEntries, numEntries, 0, numEntries - 1);
	}
	
	public static IFinitization finTreeSet_fix(int numEntries, int maxSize,int minKey, int maxKey) {
		IFinitization f = FinitizationFactory.create(TreeSet_fix.class);
