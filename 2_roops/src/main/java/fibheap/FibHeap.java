...
public class FibHeap implements java.io.Serializable{
     ...
     */
    private static FibHeap union(FibHeap H1, FibHeap H2) {
	...
	//From Korat
    public static IFinitization finFibHeap(int size) {
        IFinitization f = FinitizationFactory.create(FibHeap.class);
