...
public class BinomialHeap implements java.io.Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3030965750051030406L;

	/*@ nullable @*/ BinomialHeapNode Nodes;
	...
	public /*BinomialHeapNode*/ int extractMin() {
	...
	private static boolean repOK_nodeRepOk(BinomialHeapNode Node) {
     ...
     private static boolean repOK_isAcyclic(BinomialHeapNode start, List seen) {
