 ...
 *
 */
public class NodeCachingLinkedList implements java.io.Serializable {
	...
	public static IFinitization finNodeCachingLinkedList(int size){
		return finNodeCachingLinkedList(size, size, size, size);
	}

	public static IFinitization finNodeCachingLinkedList(int numEntries,int maxSizeList, 
