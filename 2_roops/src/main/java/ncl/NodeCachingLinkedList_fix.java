 ...
 *
 */
public class NodeCachingLinkedList_fix implements java.io.Serializable {

	//$goals 4
	//$benchmark
	public void addLastTest(NodeCachingLinkedList_fix list, Object o) {
	...
	//$goals 4
	//$benchmark
	public void containsTest(NodeCachingLinkedList_fix list, Object arg) {
	...
	//$goals 11
	//$benchmark
	public void removeIndexTest(NodeCachingLinkedList_fix list, int index) {
	...
	//$goals 5
	//$benchmark
	public void setMaximumCacheSizeTest(NodeCachingLinkedList_fix list, int new_maximumCacheSize) {
	 ...
	 * @Modifies_Everything
	 */
	//Modifies for Mariano remove index.
	public Object removeIndex(int index) {

	// public Object removeIndex() {

		LinkedListNode node = getNode(0, false);
	...
	public NodeCachingLinkedList_fix() {
	...
	public static IFinitization finNodeCachingLinkedList_fix(int size){
		return finNodeCachingLinkedList_fix(size, size, size, size);
	}

	public static IFinitization finNodeCachingLinkedList_fix(int numEntries,int maxSizeList, 
			int maxSizeCache,  int numElems) {
       
       IFinitization f = FinitizationFactory.create(NodeCachingLinkedList_fix.class);

       IObjSet entries = f.createObjSet(LinkedListNode.class, true);
       
       IClassDomain cd = f.createClassDomain(LinkedListNode.class, numEntries);
       cd.includeInIsomorphismCheck(true);
       entries.addClassDomain(cd);	
       ...
       IIntSet sizesList = f.createIntSet(0, maxSizeList);

       
       IIntSet sizesCache = f.createIntSet(0, maxSizeCache);
       
       
       f.set("header", entries);
       f.set("size", sizesList);
       
       f.set("firstCachedNode", entries);
       
       f.set("cacheSize", sizesCache);
       // f.set("maximumCacheSize",sizesCache);
	   ...
	   //*************************************************************************
	    ...
	    public boolean repOK()
	    {
	        ...
	        while (m != null)
	        {
	            ...
	            if (m.previous != null)
	              return false;
     			//Bug. values from cachelist are equals to null
	            if (m.value != null)
	             return false;
...
//	          return false;
//
//	      	//value of header is null.
//	      	//Mariano
//	        //now, Restore original version
////	     	if (this.header.value != null) 
////	          return false; 
//
//	        if (this.header.previous == null)
